...
Run `./build-xcframework.sh` from this directory. The script checks out the exact upstream revisions below, builds each Mac architecture separately, combines the static archives, and replaces `Artifacts/FunASRRuntime.xcframework`.
