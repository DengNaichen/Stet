drop function if exists public.begin_managed_usage(uuid, text, text, text, numeric);
drop function if exists public.finalize_managed_usage(uuid, numeric, integer, integer);
