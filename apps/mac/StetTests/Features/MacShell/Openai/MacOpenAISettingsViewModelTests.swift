...
struct MacOpenAISettingsViewModelTests {
    ...
    @Test func byokMixedProvidersRequireBothKeys() {
        ...
        #expect(viewModel.missingCredentialMessage == "Add OpenAI and Groq API keys before using direct transcription or transcript improvement.")
    }
    ...
    @Test func unsupportedProviderPairShowsConfigurationWarning() {
        ...
        #expect(viewModel.missingCredentialMessage == "OpenAI transcription with Groq rewrite is not supported as a default BYOK pair on Mac.")
    }
}
#endif
